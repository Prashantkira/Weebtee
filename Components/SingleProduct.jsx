  ...
  return (
    <>
          ...
          <div className="col-md-6 ps-5">
            <div id="carouselExampleIndicators" className="carousel slide">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active ps-5">
                  <img
            ...
            <div className="d-flex justify-content-between mt-1 ps-5">
              <img
                src={`/products/${data.pic1}`}
                height="100px"
                width="24.7%"
          ...
          <div className="col-md-6">
            ...
            <div className="table-responsive">
              <table className='table table-bordered cellpadding="10" cellspacing="10"'>
                <tbody>
                  <tr>
                    <th className="text-center fs-6 mb-1">Category</th>
                    <td>
                      {data.maincategory}/{data.subcategory}/
                    </td>
                  </tr>
                  <tr>
                    <th className="text-center fs-6 mb-1">Brand</th>
                    <td>{data.brand}</td>
                  </tr>
                  <tr>
                    <th className="text-center fs-6 mb-1">Color/Size</th>
                    <td>
                      {data.color}/{data.size}
                    </td>
                  </tr>
                  <tr>
                    <th className="text-center fs-6 mb-1">Price</th>
                    <td>
                  ...
                  <tr>
                    <th className="text-center fs-6 mb-1">Stock</th>
                    <td>{data.stock}</td>
                  </tr>

                  <tr>
                    <th className="text-center fs-6 mb-1">Description</th>
                  ...
                  <tr>
                    <th colspan="2">
                      <div className="d-flex">
                        ...
                        >
                          <i className="fa fa-minus text-light w-25 "></i>
                        </button>
                        <span
                          className="text-center numb"
                          style={{ width: "5%" }}
                        >
                          {qty}
                        </span>
                        ...
                        >
                          <i className="fa fa-plus text-light w-25"></i>
                        </button>
                      </div>
                    </th>
                  </tr>
      ...
      {relatedproducts.length ? (
        <>
          <h6 className="text-light  bg-primary my-2 w-100 text-center p-2">
          ...
          <OwlCarousel className="owl-theme" loop margin={10} nav>
            {relatedproducts.map((item, index) => {
              return (
                <div
                  key={index}
                  className="col-md-12 wow fadeInUp m-auto"
                  data-wow-delay="0.1s"
                >
                  <div className="team-item">
                    <div className="position-relative overflow-hidden">
                      ...
                      <div className="team-overlay position-absolute start-0 top-0 w-100 h-100 ">
                        <img
                          className="img-fluid team-overlay position-absolute start-0 top-0 w-100 "
                        ...
                        <Link
                          className="btn btn-square mx-1 text-light position-absolute bg-primary w-100"
                          to={`/products/${item.id}`}
                        >
                          <i className="fa fa-shopping-cart"></i>&emsp; Add to
                          Cart
                        </Link>
                      </div>
                    </div>

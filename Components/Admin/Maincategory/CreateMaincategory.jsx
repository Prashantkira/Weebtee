...
export default function CreateMaincategory() {
  ...
  async function postData(e) {
    ...
    let item =
      ...
      MaincategoryStateData.slice(1).find((x) => x.name === name.current);

    if (item) alert("Maincategory Already Exists");
    else {
      ...
      <div className="container-fluid my-3">
        <div className="row">
          ...
          <div className="col-md-9">
            <h5 className="bg-primary text-light w-100 mb-2 text-center p-2">
              Create Maincategory
            </h5>
